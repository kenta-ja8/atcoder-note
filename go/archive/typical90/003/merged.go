...
func main() {
	...
	farthestNode1, maxDistance1 := bfs(1, neighbors)
	dbg("first: ", farthestNode1, "-", maxDistance1)
	farthestNode2, maxDistance2 := bfs(farthestNode1, neighbors)
	dbg("second: ", farthestNode2, "-", maxDistance2)
	out(maxDistance2 + 1)
}
